...
// Time Complexity: O(n), where n is the number of nodes in the linked list, as we traverse the list to find the second last node.
// Space Complexity: O(1), as we are using a constant amount of extra space for the temporary pointer.